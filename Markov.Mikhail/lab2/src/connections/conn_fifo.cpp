...
NamedChanel::NamedChanel(const std::string & pathname, bool create) : pathname(pathname)
{
    if (create)
...
bool NamedChanel::Read(std::string& message)
{
...
bool NamedChanel::Write(const std::string &message)
{
