...
private slots:
    virtual void handleBookSelected(std::string const& bookName, alias::id_t clientId) = 0;
    virtual void handleBookReturned(std::string const& bookName, alias::id_t clientId) = 0;
